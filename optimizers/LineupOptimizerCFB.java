/*
 * LineupOptimizerCFB.java
 * by: Philip Rotella
 * Date: 16 Sep 15
 * 
 * Given a csv file of CFB fantasy player data (4 columns: player name,
 ...
 * following: QB, RB, WR, TE. File needs to be presorted from high to low
 * fantasy points.
 * 
 */
...
public class LineupOptimizerCFB {
    
    ///Standard FanDuel Settings///
  
    public static final String[] POSITIONS = 
    {"RB", "RB", "WR", "WR", "WR", "QB", "TE"}; 
    ...
    public static void main(String[] args) 
        ...
        Scanner input = new Scanner(new File("college_week_3.csv"));      
        int rank = 15;
