/*
 * LineupOptimizerNFL_Stack.java
 * by: Philip Rotella
 * Date: 26 Sep 15
 * 
 * Given a csv file of NFL fantasy player data (5 columns: player name,
 * position, team, projected fantasy points, cost), uses recursive backtracking 
 * to find the top X rosters to maximize projected fantasy points. User modifies
 * main method to specify X and the filename). Positions must be one of the 
 * following: QB, RB, WR, TE, K, D. Will only count rosters where that pair
 * QB and at least one WR/TE from the same team
 * 
 * 
 * 
 */
...
public class LineupOptimizerNFL_Stack {
    ...
    public static void main(String[] args) 
        ...
        Scanner input = new Scanner(new File("FP low 4.csv"));      
        int rank = 50;
